import type { EventRecord, GameListItem, GameSummary, HistoryPoint } from './types'
...
export const api = {
  ...
  createGame: (seed: number, tickRate: number, paused = false) =>
    post<GameSummary>('/games', { seed, tick_rate: tickRate, paused }),
